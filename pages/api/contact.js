...
export default async (req, res) => {
  ...
  try {
    const emailRes = await transporter.sendMail({
      from: email,
      to: `${process.env.user}`,
      subject: `No Booze Beverages Contact from ${name}`,
      html: `
      <html>
        <head>
          <meta charset="UTF-8">
          <meta http-equiv="X-UA-Compatible" content="IE=edge" />
          <title>No Booze Beverages Contact Form</title>
            ...
            <center class="wrapper" style="table-layout: fixed; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; padding: 0; margin: 0 auto; width: 100%; max-width: 960px;">
                ...
                <table cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="padding: 0; margin: 0 auto; width: 100%; max-width: 960px;">
                  <tbody>
                    <tr>
                      <td align="center">
                        <table id="intro" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" align="center" style="width: 100%; padding: 0; margin: 0; background-image: url(https://github.com/NickSaindon/no-booze-beverages/blob/main/public/images/contact-header.jpg?raw=true); background-size: auto 102%; background-position: center center; background-repeat: no-repeat; background-color: #000000">
                          <tbody >
                            ...
                            <tr>
                              ...
                              <td align="center">
                                <div border="0" style="border: none; height: 60px;">
                                  <img src="https://github.com/NickSaindon/no-booze-beverages/blob/main/public/images/no-booze-logo.png?raw=true" alt="No Booze Beverages" width="200" height="200" border="0" style="border: none; display: block; -ms-interpolation-mode: bicubic;">
                                </div>
                              </td>
                              <td width="90" style="width: 9%;"></td>
                            </tr>
                            ...
                            <tr>
                              <td colspan="3" height="60" align="center">
                                <div border="0" style="border: none; line-height: 60px; color: #ffffff; font-family: Verdana, Geneva, sans-serif; font-size: 52px; text-transform: uppercase; font-weight: bolder;">No Booze Beverages Contact</div>
                              </td>
                            </tr>
                            <tr>
                                      ...
                                      <td align="center">
                                        <div border="0" style="border: none; height: 60px;">
                                          <p style="font-size: 18px; line-height: 24px; font-family: Verdana, Geneva, sans-serif; color: #ffffff; text-align: center; mso-table-lspace:0;mso-table-rspace:0;">
                                            This is an email from the No Booze Beverages website contact form.  Please try and return this message with any answers to questions. 
                                          </p>
                                        </div>
                                      </td>
                                      <td width="90" style="width: 9%;"></td>
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td align="center">
                                        ...
                                        <p style="line-height: 20px; color: #207a00; font-family: Verdana, Geneva, sans-serif; font-size: 16px; text-align: center; overflow: hidden; margin: 10px 0; mso-table-lspace:0;mso-table-rspace:0;"> 
                                          ${email}
                                        </p>
                                      </td>
                                      <td width="80" style="width: 8%;"></td>
                        ...
                        <table id="news__article" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" align="center" style="width: 100%; padding: 0; margin: 0; background-color: #ffffff">
                          <tbody>
                            <tr>
                              <td align="center">
                                <div border="0" style="border: none; line-height: 14px; color: #207a00; font-family: Verdana, Geneva, sans-serif; font-size: 16px;">
                                  2023 © No Booze Beverages
                                </div>
                              </td>
                            </tr>
